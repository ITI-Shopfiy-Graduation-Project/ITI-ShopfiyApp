...
class variants: Decodable{
    ...
    init(id: Int? = nil, product_id: Int? = nil, inventory_item_id: Int? = nil, price: String? = nil, inventory_quantity: Int? = nil, old_inventory_quantity: Int? = nil, option1: String? = nil, option2: String? = nil) {
        self.id = id
